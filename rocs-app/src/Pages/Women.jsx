...
const shoe = [
  {
    image:
      "https://media.crocs.com/images/t_thumbnail/f_auto%2Cq_auto/products/10001_3UG_ALT100/crocs-classic-clog",
    name: "Classic cloc",
    num: "30577",
    p1: "243",
    p2: "456",
  ...
  {
    image:
      "https://media.crocs.com/images/t_thumbnail/f_auto%2Cq_auto/products/203591_5Q6_ALT100/crocs-classic-lined-clog",
  ...
  {
    image:
      "https://media.crocs.com/images/t_thumbnail/f_auto%2Cq_auto/products/207938_2Y2_ALT100/crocs-women-s-classic-platform-lined-clog",
...
const Women = () => {
  ...
  return (
    <div>
     <h3 style={{textAlign:"left"}}>Women Shoe Products</h3>
      <Products data={data} />
    </div>
  );
};
